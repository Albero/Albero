...
*/
package nl.trivento.albero;

import static nl.trivento.albero.configuration.DefaultConfiguration.PARSER_CLASSES;
import static nl.trivento.albero.configuration.DefaultConfiguration.REPOSITORY_CLASS;
import static nl.trivento.albero.configuration.DefaultConfiguration.TRAVERSAL_STRATEGY_CLASSES;
import static nl.trivento.albero.model.Context.ALBERO;
...
public class EngineTest {
	...
	public void createEngineAndContext() {
		...
		configurationParameters.put(REPOSITORY_CLASS, "nl.trivento.albero.repositories.CodeRepository");
		configurationParameters.put(PARSER_CLASSES, "nl.trivento.albero.parsers.CodeParser");
		configurationParameters.put(TRAVERSAL_STRATEGY_CLASSES,
			"nl.trivento.albero.traversal.FirstEvaluatableNodePickingTraversalStrategy");
