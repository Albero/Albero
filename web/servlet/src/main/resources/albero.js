...
nl.profict.albero = function() {
	...
	Albero.prototype = {
		...
		createForm: function(formDescriptor) {
			var addForm = Utilities.bind(this, function(parent, formDescriptor, addForm, addElement) {
				...
				if (formDescriptor.forms) {
					...
					for (var i = 0; i < formDescriptor.elements.length; i++) {
						...
						addTooltip(block,elementDescriptor,'toolTip');
					}
				}
			...
			var addTooltip = Utilities.bind(this, function(parent, descriptor, type) {
				if (descriptor.renderedTexts[type]) {
					var tooltip = document.createElement('div');
					tooltip.className='tooltipspot';
					tooltip.setAttribute('onmouseover','tooltip.show("'+descriptor.renderedTexts[type]+'")');
					tooltip.setAttribute('onmouseout', 'tooltip.hide()');
			...
			submitBlock.className='submit';

			var submit = document.createElement('button');
			submit.setAttribute('type', 'submit');
			submit.setAttribute('class', 'btn primary');
			submit.appendChild(document.createTextNode('Ga verder'));				
